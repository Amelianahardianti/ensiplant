...
fun uploadPlantsToFirestore(context: Context) {
    ...
    val plantList: List<Plant> = gson.fromJson(jsonString, object : TypeToken<List<Plant>>() {}.type) //list data di data plant file kt dan file itu sama dengan file json datanya
